...
def main() -> None:
    ...
    # Drop rows with missing target (keep preprocessing to handle other NaNs)
    ...
    out_fp = OUT_DIR / "revenue_model_coefficients.csv"
    coef_df.to_csv(out_fp, index=False)
